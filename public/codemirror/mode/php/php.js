...
(function(mod) {
  ...
  CodeMirror.defineMode(
    'php',
    (config, parserConfig) => {
      const htmlMode = CodeMirror.getMode(config, 'text/html');
      const phpMode = CodeMirror.getMode(config, phpConfig);
      ...
      return {
        startState() {
          const html = CodeMirror.startState(htmlMode);
          const php = parserConfig.startOpen
